            ...
            try:
                ...
                with open(goodFilePath+'/'+file, "r") as f:
                    ...
                    try:
                        ...
                        #print(header)
                        for rec in reader:
                            #conn.execute(f"INSERT INTO Good_Raw_Data VALUES ({','.join(rec)})")
                            conn.execute("INSERT INTO Good_Raw_Data VALUES %s" %str(tuple(rec)))
                            #conn.execute("INSERT INTO Good_Raw_Data (ID,Year_Birth,Education,Marital_Status,Income,Kidhome,Teenhome,Dt_Customer, Recency,MntWines,MntFruits,MntMeatProducts,MntFishProducts,MntSweetProducts,MntGoldProds,NumDealsPurchases, NumWebPurchases,NumCatalogPurchases,NumStorePurchases,NumWebVisitsMonth,AcceptedCmp3,AcceptedCmp4,AcceptedCmp5,AcceptedCmp1,AcceptedCmp2,Complain,Z_CostContact,Z_Revenue) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", tuple(rec))

                            #conn.execute("INSERT INTO Good_Raw_Data (ID,Year_Birth,Education,Marital_Status,Income,Kidhome,Teenhome,Dt_Customer, Recency,MntWines,MntFruits,MntMeatProducts,MntFishProducts,MntSweetProducts,MntGoldProds,NumDealsPurchases, NumWebPurchases,NumCatalogPurchases,NumStorePurchases,NumWebVisitsMonth,AcceptedCmp3,AcceptedCmp4,AcceptedCmp5,AcceptedCmp1,AcceptedCmp2,Complain,Z_CostContact,Z_Revenue) VALUES %s" %str(tuple(rec)))
